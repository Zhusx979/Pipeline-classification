...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Stage1 training entry point.")
    parser.add_argument("--preset", default="resnet50_dino_pointwise", choices=sorted(MODEL_PRESETS.keys()))
...
def main():
    ...
    from configs.config import DEFAULT_DINO_PATH, build_experiment_config
    ...
    cfg = build_experiment_config(
        ...
        extra={"save_features": args.save_features},
    )
